  ...
  function dragProcess() {
    ...
    if (lastHoverTreeItem !== hoverTreeItem || placement !== lastPlacement) {
      ...
      if (placement === "center") {
        ...
        if ((_b = hoverTreeNode.data) == null ? void 0 : _b.disableDragIn)
          return;
      ...
      const prevId = (_c = prevTreeItem == null ? void 0 : prevTreeItem.dataset) == null ? void 0 : _c.id;
      const nextId = (_d = nextTreeItem == null ? void 0 : nextTreeItem.dataset) == null ? void 0 : _d.id;
      prevElementNode = prevId ? getTreeNode(prevId) : void 0;
      nextNode = nextId ? getTreeNode(nextId) : void 0;
      minLevel = Math.min((_e = prevElementNode == null ? void 0 : prevElementNode.level) != null ? _e : 1, (_f = nextNode == null ? void 0 : nextNode.level) != null ? _f : 1);
      maxLevel = Math.max((_g = prevElementNode == null ? void 0 : prevElementNode.level) != null ? _g : 1, (_h = nextNode == null ? void 0 : nextNode.level) != null ? _h : 1);
      dragLine.innerHTML = "";
